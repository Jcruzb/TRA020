...
function App(){
 ...
 async function attach(id,file){
   ...
   if(file.size>10_000_000){setNotice({type:'error',text:'El adjunto supera el límite de 10 MB.'});return;}
 ...
 function requestExport(kind){
   ...
   if(kind==='ordered' && (!job.signed.anexo || !job.signed.commitment || !job.signed.calculation)){setNotice({type:'error',text:'Adjunta el Anexo I, el cálculo del ahorro y el Compromiso del Gerente firmados antes de generar el expediente.'});return;}
